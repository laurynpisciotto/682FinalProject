...
library(magrittr)
library(knitr)
file_path <- '/Users/laurynpisciotto/Downloads/T0_MCAP_run_1_light_7_5_2023.xlsx'
T0_list <- list()
...
# -------------------------------------------------------------------------
####6a: Plotting at entire time interval (0-61 Minutes)
```{r}
library(dplyr)
start_time <- 0.0
end_time <- 61
...
```{r}
library(readxl)
file_path <- '/Users/laurynpisciotto/Desktop/682FinalProject/T0_MCAP_run_1_dark_7_5_2023.xlsx'
T0_list <- list()
sheet_names <- c('SABD0000000003, Ch 2', 'SABD0000000003, Ch 3', 'SABD0000000003, Ch 4',
                 'SABD0000000003, Ch 5', 'SABD0000000003, Ch 6', 'SABD0000000003, Ch 7',
                 'SABD0000000003, Ch 8', 'SABD0000000003, Ch 9', 'SABD0000000003, Ch 10')
...
# -------------------------------------------------------------------------
####6b: Plotting at entire time interval (0-61 Minutes)
```{r}
library(dplyr)
start_time <- 0.0
end_time <- 61
...
excel_file_path <- '/Users/laurynpisciotto/Downloads/T0_MCAP_Frag_ID_List (1).xlsx'
...
```{r}
write.csv(merged_slope_table, file = '/Users/laurynpisciotto/Desktop/682FinalProject/run_1_final.csv', row.names = FALSE)
```
